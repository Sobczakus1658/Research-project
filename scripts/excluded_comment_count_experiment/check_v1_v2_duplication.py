"""
Verifies the claim behind data_to_excluded_comment_count_experiment.sql's comment that
...
if v1_only == 0 and body_mismatch == 0:
    print("CONFIRMED: v1 is a strict subset of v2 (same id -> identical body). "
          ...
          "this is why data_to_excluded_comment_count_experiment.sql uses v2 only.")
