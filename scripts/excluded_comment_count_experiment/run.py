...
def run_excluded_comment_count_experiment():
    exp_df = pd.read_csv('../../data/excluded_comment_count_experiment/data_to_excluded_comment_count_experiment.csv')
    ...
    summary_stats.to_csv('../../data/excluded_comment_count_experiment/excluded_comment_count_experiment_summary_stats.csv', index=False)
    ...
    plt.tight_layout()
    table_path = '../../results/excluded_comment_count_experiment_summary_table.png'
    ...
    plot_path = '../../results/excluded_comment_count_experiment_boxplot.png'
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    plt.close()
    print(f"Boxplot figure saved to: {plot_path}")

if __name__ == '__main__':
    run_excluded_comment_count_experiment()