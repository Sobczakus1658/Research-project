WITH combined_comments AS (
    ...
    UNION ALL
    SELECT r.pr_id, c.user, c.user_type, c.id FROM pr_review_comments c JOIN pr_reviews r ON c.pull_request_review_id = r.id WHERE c.user_type = 'User'
    UNION ALL
