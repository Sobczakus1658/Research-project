...
def run_third_experiment():
    ...
    merged_df.to_csv('../../data/third_experiment/third_experiment_merged.csv', index=False)
    ...
    summary_stats.to_csv('../../data/third_experiment/third_experiment_summary_stats.csv')
